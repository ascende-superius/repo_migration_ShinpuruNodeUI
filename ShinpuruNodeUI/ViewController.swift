...
class ViewController: UIViewController
{
    ...
    func buildUserInterface()
    {
        ...
        slider.addTarget(self, action: #selector(sliderChangeHandler), for: UIControlEvents.valueChanged)
        
        // operators segmented control
        operatorsControl.isEnabled = false
        operatorsControl.tintColor = UIColor.white
        operatorsControl.addTarget(self, action: #selector(operatorsControlChangeHandler), for: UIControlEvents.valueChanged)
        
        // isOperatorSwitch
        isOperatorSwitch.isEnabled = false
        isOperatorSwitch.addTarget(self, action: #selector(isOperatorSwitchChangeHandler), for: UIControlEvents.valueChanged)
